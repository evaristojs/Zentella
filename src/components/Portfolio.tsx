        ...
        <AnimatePresence>
          {isModalOpen && selectedItem && (
            ...
            >
              ...
              />
              <motion.div 
                className="relative bg-bg-secondary-light dark:bg-bg-secondary-dark max-w-6xl w-full max-h-[calc(90vh-8rem)] xl:h-full xl:max-h-[calc(100vh-100px)] overflow-y-auto rounded-2xl border border-gray-200/50 dark:border-gray-700/50 flex flex-col md:flex-row"
