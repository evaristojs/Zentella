      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <motion.p
            ...
            className="text-lg text-text-secondary-light dark:text-text-secondary-dark max-w-2xl mx-auto leading-relaxed" style={{textAlign: 'justify', textAlignLast: 'center', hyphens: 'auto', wordSpacing: 'normal'}}
          >
              ...
              <div className="relative overflow-hidden rounded-3xl aspect-[3/4] shadow-2xl shadow-black/30 hover:shadow-3xl transition-all duration-500 group-hover:scale-[1.02]">
                ...
                <div className="absolute inset-0 p-6 flex flex-col justify-center items-center text-white opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-8 group-hover:translate-y-0">
                  <div className="text-center max-w-xs">
                    <p className="text-sm leading-relaxed mb-6 backdrop-blur-sm bg-black/20 p-4 rounded-xl" style={{textAlign: 'justify', textAlignLast: 'left', hyphens: 'auto', wordSpacing: 'normal'}}>
                      {member.description}
                    </p>
